...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public List<User> getAllUsers(){
        ...
        if (c.moveToFirst()) {
            do {
                users.add(new User(Integer.parseInt(c.getString(0)), c.getString(1), c.getString(2)
    ...
    public User getUser(int i){
        ...
        getUser = new User(Integer.parseInt(c.getString(0)), c.getString(1), c.getString(2)
                        , c.getString(3), Uri.parse(c.getString(4)), Integer.parseInt(c.getString(5))
                        , Integer.parseInt(c.getString(6)));
