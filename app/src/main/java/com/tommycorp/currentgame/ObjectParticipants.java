...
public class ObjectParticipants {

    private int _spell1Id, _spell2Id, _championId, _profileIconId, _summonerId;
    private String _summonerName;

    public ObjectParticipants(int spell1Id, int spell2Id, int championId, int profileIconId, int summonerId, String summonerName){
        _spell1Id = spell1Id;
        _spell2Id = spell2Id;
